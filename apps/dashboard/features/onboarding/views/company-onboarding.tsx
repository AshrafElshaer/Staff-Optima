...
import { companyInsertSchema } from "@optima/supabase/validations";
...
import { onboardCompanyAction } from "../onboarding.actions";
...
function CompanyForm() {
	...
	const form = useForm<z.infer<typeof companyInsertSchema>>({
	...
	const { executeAsync: createCompany, status } = useAction(
	...
	async function onSubmit(data: z.infer<typeof companyInsertSchema>) {
