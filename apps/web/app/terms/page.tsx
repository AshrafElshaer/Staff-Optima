			...
			<div className="flex flex-col gap-8 pt-8">
				<div className="flex flex-col gap-2">
					<p>
						...
						your relationship with Staff Optima application (the "Service")
						operated by Staff Optima Inc, ("us", "we", or "our").
					</p>
					<p>
						Please read these Terms and Conditions carefully before using our
						Staff Optima application (the "Service"). application (the
						"Service").
					</p>
					<p>
				...
				<Card>
					<CardHeader>
						<CardTitle className="text-lg font-bold">Fee Changes</CardTitle>
					</CardHeader>
					<CardContent className="space-y-4">
						<p>
							Staff Optima Inc., in its sole discretion and at any time, may
						...
						<p>
							Staff Optima Inc. will provide you with a reasonable prior notice
				...
				<Card>
					<CardHeader>
						<CardTitle className="text-lg font-bold">Refunds</CardTitle>
					</CardHeader>
					<CardContent>
						<p>
							Certain refund requests for Subscriptions may be considered by
							Acre Labs AB on a case-by-case basis and granted in sole
							discretion of Staff Optima Inc.
						</p>
					</CardContent>
				</Card>
				...
				<Card>
					...
					<CardContent className="space-y-4">
						...
						<p>
							...
							attention of "Copyright Infringement" of dmca@fxresearch.app and
				...
				<Card>
					...
					<CardContent>
						<p>
							...
							exclusive property of Staff Optima Inc. and its licensors. The
							Service is protected by copyright, trademark, and other laws of
							both the Sweden and foreign countries. Our trademarks and trade
							dress may not be used in connection with any product or service
							without the prior written consent of Staff Optima Inc.
						</p>
					</CardContent>
				</Card>
				...
				<Card>
					...
					<CardContent className="space-y-4">
						<p>
							...
							that are not owned or controlled by Staff Optima Inc.
						</p>
						<p>
							Staff Optima Inc. has no control over, and assumes no
							responsibility for, the content, privacy policies, or practices of
							any third party web sites or services. You further acknowledge and
							agree that Acre Labs Ab shall not be responsible or liable,
				...
				<Card>
					<CardHeader>
						<CardTitle className="text-lg font-bold">Termination</CardTitle>
					</CardHeader>
					<CardContent className="space-y-4">
						<p>
				...
				<Card>
					...
					<CardContent>
						<p>
							In no event shall Staff Optima Inc., nor its directors, employees,
				...
				<Card>
					<CardHeader>
						<CardTitle className="text-lg font-bold">Disclaimer</CardTitle>
					</CardHeader>
					<CardContent className="space-y-4">
						<p>
						...
						<p>
							Staff Optima Inc. its subsidiaries, affiliates, and its licensors
				...
				<Card>
					<CardHeader>
						<CardTitle className="text-lg font-bold">Governing Law</CardTitle>
					</CardHeader>
					<CardContent className="space-y-4">
						<p>
				...
				<Card>
					<CardHeader>
						<CardTitle className="text-lg font-bold">Changes</CardTitle>
					</CardHeader>
					<CardContent className="space-y-4">
						<p>
