				...
				<section className="overflow-hidden bg-white dark:bg-transparent">
					<div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-24">
						<div className="relative z-10 mx-auto max-w-4xl text-center">
							<h1 className="text-balance text-lg sm:text-2xl font-semibold md:text-4xl lg:text-5xl">
							...
							<p className="text-secondary-foreground w-full sm:w-2/3 mx-auto text-sm md:text-base lg:text-lg text-center my-8">
